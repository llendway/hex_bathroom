 ...
 mutate(x = x + floor_distance) %>% 
  ...
  geom_polygon(color = "black",
               aes(x = x,
                   ...
                   group = group,
                   fill = colors)) +
  geom_polygon(data = . %>% filter(group %in% c(make_star(2465, 111),
                                                make_star(2483, 111),
                                                make_star(4907, 111),
                                                make_star(4925, 111),
                                                make_star(4943, 111),
               ...
               aes(x = x,
                   y = y, 
                   group = group)) +
  geom_polygon(data = . %>% filter(group %in% c(2465 + 4*111, 
                                                2483 + 4*111, 
                                                4907 + 4*111, 
                                                4925 + 4*111, 
                                                4943 + 4*111, 
...
Change shower design and get the dimensions of shower correct.
...
dg_chris <- c(1521 + c(2, 3, 5, 7, 8, 10, 12, 13, 15, 17, 18),
              1557 + c(2, 5, 6, 8, 11, 13, 14, 17),
              1485 + c(2, 5, 6, 8, 11, 13, 14, 17),
              1593 + c(6, 9, 11, 14),
              1449 + c(6, 9, 11, 14),
              1629 + c(4, 5, 9, 10, 14, 15), 
              1413 + c(4, 5, 9, 10, 14, 15),
              1665 + c(6, 9, 11, 14),
              1377 + c(6, 9, 11, 14),
              1701 + c(9, 10),
              1341 + c(9, 10),
...
bathroom %>% 
 mutate(x = x + floor_distance) %>% 
  ...
  #              alpha = .7,
  #              color = "black") +
  geom_polygon(data = tibble(x = c(98.5, 98.5, 102.5, 102.5, 98.5) + floor_distance,
                             y = c(25 + 5/8, 78, 78, 25 + 5/8, 25 + 5/8)),
               aes(x = x,
                   y = y),
               fill = "gray",
  ...
  geom_polygon(data = tibble(x = c(102.5, 102.5, 111.5, 111.5, 102.5) + floor_distance,
                             y = c(25 + 5/8, 78, 78, 25 + 5/8, 25 + 5/8)),
               aes(x = x,
                   y = y),
               fill = "white") +
  ...
  #              color = "black",
  #              alpha = .7) +
  geom_segment(data = tibble(x = 36, y = 0, xend = 36, yend = 78),
               aes(x = x, y = y, xend = xend, yend = yend),
               size = 2,
               color = hex_color) +
  # geom_ellipse(data = tibble(x0 = 15.5 + floor_distance,
  ...
  scale_y_continuous(breaks = seq(0, 144, 12)) +
  coord_equal() +
  theme_void()
```

```{r}
ggsave("bathroom_floorplan.pdf", width = 24, height = 24, units = "in")
```


Try changing color of floor star pattern.
 ...
 mutate(x = x + floor_distance) %>% 
  ...
  geom_polygon(data = . %>% filter(group %in% c(2465 + 4*111, 
               ...
               aes(x = x,
                   y = y, 
                   group = group)) +
  geom_polygon(data = . %>% filter(group %in% c(2465 + 8*111, 
                                                2483 + 8*111, 
                                                4907 + 8*111, 
                                                4925 + 8*111, 
                                                4943 + 8*111, 
  ...
  geom_polygon(data = tibble(x = c(99, 99, 111.5, 111.5, 99) + floor_distance,
               ...
               color = "black",
               alpha = .7) +
  geom_segment(data = tibble(x = 36, y = 0, xend = 36, yend = 76),
               aes(x = x, y = y, xend = xend, yend = yend),
               size = 2) +
  geom_ellipse(data = tibble(x0 = 15.5 + floor_distance,
                   y0 = 11.5,
